...
public class LettersApiController : ControllerBase
{
    private readonly IHtmlTemplateSetup _engine;
    private readonly SenderSettings _sender;
    private readonly ILogger<LettersApiController> _logger;
    private readonly IWebHostEnvironment _env;

    public LettersApiController()
    {
    }

    public LettersApiController(IHtmlTemplateSetup engine, SenderSettings sender, ILogger<LettersApiController> logger, IWebHostEnvironment env)
    {
        _engine = engine;
        _sender = sender;
        _logger = logger;
